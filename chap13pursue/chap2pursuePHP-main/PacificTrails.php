...
<body>
    <?php
    // Define the spam_scrubber() function
    function spam_scrubber($value)
    {
        // List of bad values to remove
        $badWords = array('to:', 'cc:', 'bcc:', 'content-type:', 'mime-version:', 'multipart-mixed:', 'content-transfer-encoding:');

        // Loop through the array of bad values
        foreach ($badWords as $word) {
            // Check if the value contains the bad word
    ...
    // Scrub the form data using the spam_scrubber() function
